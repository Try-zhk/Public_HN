```env
WORKER_ENDPOINT=https://prrealy.xihun.cloudns.org/code/HN
...
# Account username password 2fa key
HN_ACCOUNTS_1=your_username_here your_password_here your_2fa key_here
HN_ACCOUNTS_2=your_username_here your_password_here your_2fa key_here
...
This `GH_PAT` is used to allow the workflow to **automatically write and update `DISCORD_HN` variables** in the repository.
